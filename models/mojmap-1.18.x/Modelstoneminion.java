...
public class Modelstoneminion<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "stoneminion"), "main");
	private final ModelPart head;
	private final ModelPart stoneCircle;
	private final ModelPart stoneCircle2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-6.0F, -2.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition stoneCircle = partdefinition.addOrReplaceChild("stoneCircle",
				CubeListBuilder.create().texOffs(30, 20)
						.addBox(-12.0F, -2.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
		...
		PartDefinition stoneCircle2 = partdefinition.addOrReplaceChild("stoneCircle2",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(-12.2929F, -2.0F, -1.7071F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 23)
						.addBox(9.7071F, -2.0F, -1.7071F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 20)
